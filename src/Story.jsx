  ...
  return (
    ...
    <div className='flex'>
      ...
      <div className='story-section'>
        ...
        <form id="form" className='section-1' >
            ...
            { content && <div className='section-1-content' >
              ...
              <button type='submit' className='submit-btn' id="submitt" onClick={handleSubmit}>
                  PUBLISH YOUR STORY
              </button>
        ...
        <section className='section-2'>
          ...
          <div className='section-2-head'>
            <h1>Read on {handleCategorySelect.data}</h1>
            ...
            <img src="star.svg" id="element" width="30px" height="20px"/>
   
    Sort<CgArrowsExchangeAltV  className='filterarrow' onClick={handleflip}/>
